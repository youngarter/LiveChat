package com.bringletech.looviedraft.livechat;
...
import com.bringletech.looviedraft.livechat.service.ServiceUtils;
import com.bringletech.looviedraft.livechat.ui.FriendsFragment;
import com.bringletech.looviedraft.livechat.ui.GroupFragment;
import com.bringletech.looviedraft.livechat.ui.LoginActivity;
import com.bringletech.looviedraft.livechat.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.w(StaticConfig.TAG+"  "+TAG,"UIIIIDDDDD " + StaticConfig.UID);
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Youngsoft LiveChat version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
